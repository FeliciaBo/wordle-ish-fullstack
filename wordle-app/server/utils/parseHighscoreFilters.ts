import type { HighscoreFilters, RawHighscoreFilters } from "../types/highscoreFilters.js";

function parseHighscoreFilters(rawFilters: RawHighscoreFilters): HighscoreFilters {
  const filters: HighscoreFilters = {};
